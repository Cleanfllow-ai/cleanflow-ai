...
const STAGE_STYLE: Record<StageKind, {
  ...
  source: {
    ...
    Icon: Cloud,
    badgeTone: "bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-500/10 dark:text-slate-300 dark:border-slate-500/30",
    label: "Source",
  },
  validate: {
    ...
    Icon: ShieldCheck,
    badgeTone: "bg-sky-50 text-sky-700 border-sky-200 dark:bg-sky-500/10 dark:text-sky-400 dark:border-sky-500/30",
    label: "Validate",
  },
  dq: {
    ...
    Icon: Sparkles,
    badgeTone: "bg-violet-50 text-violet-700 border-violet-200 dark:bg-violet-500/10 dark:text-violet-400 dark:border-violet-500/30",
    label: "Data Quality",
  },
  output: {
    ...
    Icon: Database,
    badgeTone: "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/30",
    label: "Output",
  },
  export: {
    ...
    Icon: Send,
    badgeTone: "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-500/10 dark:text-amber-400 dark:border-amber-500/30",
    label: "Export",
  },
}
