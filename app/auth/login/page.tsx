  ...
  return (
    <div className="min-h-screen flex bg-background text-foreground">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <h1 className="text-[2.75rem] font-bold leading-[1.1] text-white tracking-tight">
                  Enterprise-grade
                  <br />
                  <span className="text-[#69C04B]">data quality.</span>
                </h1>
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center p-8 lg:p-16 bg-background">
        <div className="w-full max-w-[420px] bg-card border border-border shadow-lg dark:shadow-[0_40px_120px_rgba(0,0,0,0.18)] rounded-[32px] p-8">
