...
import { Loader2, CheckCircle2, AlertCircle, HardDrive } from 'lucide-react'
        ...
        try {
            ...
            if (success === 'true') {
                ...
                if (window.opener) {
                    ...
                    setTimeout(() => {
                        router.push('/files?googledrive=connected')
                    }, 2000)
                }
            } else {
            ...
            if (window.opener) {
                ...
                setTimeout(() => {
                    router.push('/files?googledrive=error')
                }, 3000)
            }
        }
    }
    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-4 font-sans">
            <div className="bg-card border rounded-xl shadow-lg p-8 max-w-sm w-full">
                <div className="text-center">
                    <div className="mb-5">
                        <HardDrive className="h-12 w-12 text-blue-500 mx-auto animate-pulse" />
                    </div>
